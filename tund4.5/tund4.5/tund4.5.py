...
while True:
            try:
                ...
                if ikood.isdigit() and len(ikood)==1:
                    ik_list=list(ikood)
                    if int(ik_list[0]) in [1,3,5]:
                        ...
                        print("esimene symbol on vale!")
                        continue
                    print("2-7 s. kontroll")
                    if int(ik_list[1]+ik_list[2]) in range (0,100):
                        print("2,3 symblid on ok")
                        if int(ik_list[3]+ik_list[4]) in range (1,13):
                            print("4,5 symbolid on ok")

                        else:
                            print("4,5 symbolid ei ole ok")
                    else:
                        print("2,3 symbolid ei ole ok")
                else:
                    print("ikood on numbrid")
